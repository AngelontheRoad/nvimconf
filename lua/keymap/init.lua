...
local plug_map = {
	...
	["n|<leader>o"] = map_cr("Lspsaga outline"):with_noremap():with_silent():with_desc("lsp: Toggle outline"),
	...
	["n|<leader>n"] = map_cr("Lspsaga rename"):with_noremap():with_silent():with_desc("lsp: Rename in file range"),
	["n|<leader>N"] = map_cr("Lspsaga rename ++project")
		:with_noremap()
		:with_silent()
